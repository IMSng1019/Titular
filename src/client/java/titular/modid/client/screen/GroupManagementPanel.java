...
public final class GroupManagementPanel {
    ...
    public void install(TitularScreen screen, int x, int y) {
        ...
        TextFieldWidget id = field(screen, x, y, "group id");
        TextFieldWidget parent = field(screen, x, y + 24, "parent id");
        TextFieldWidget titleIds = field(screen, x, y + 48, "title ids (comma separated)");
        ButtonWidget create = ButtonWidget.builder(Text.translatable("titular.screen.create"), ignored -> {
        ...
        ButtonWidget update = ButtonWidget.builder(Text.translatable("titular.screen.update"), ignored -> {
            String groupId = id.getText().trim();
        ...
        ButtonWidget delete = ButtonWidget.builder(Text.translatable("titular.screen.delete"), ignored -> {
            String groupId = id.getText().trim();
    ...
    private static TextFieldWidget field(TitularScreen screen, int x, int y, String hint) {
        TextFieldWidget field = new TextFieldWidget(screen.getTextRenderer(), x, y, 220, 20, Text.literal(hint));
