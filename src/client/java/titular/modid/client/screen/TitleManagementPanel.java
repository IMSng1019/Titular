...
public final class TitleManagementPanel {
    ...
    public void install(TitularScreen screen, int x, int y) {
        ...
        TextFieldWidget id = new TextFieldWidget(screen.getTextRenderer(), x, y, 220, 20, Text.translatable("titular.screen.title_id"));
        ...
        ButtonWidget create = ButtonWidget.builder(Text.translatable("titular.screen.create"), ignored -> send(screen, id, prefixDocument, suffixDocument, true))
                .dimensions(x, y + 122, 70, 20).build();
        ButtonWidget update = ButtonWidget.builder(Text.translatable("titular.screen.update"), ignored -> send(screen, id, prefixDocument, suffixDocument, false))
                .dimensions(x + 75, y + 122, 70, 20).build();
        ...
        }).dimensions(x + 150, y + 122, 70, 20).build();
